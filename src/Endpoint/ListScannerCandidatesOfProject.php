...
class ListScannerCandidatesOfProject extends \Scottbass3\Harbor\Api\Runtime\Client\BaseEndpoint implements \Scottbass3\Harbor\Api\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectBadRequestException
     * @throws \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectUnauthorizedException
     * @throws \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectForbiddenException
     * @throws \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectBadRequestException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (401 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectUnauthorizedException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (403 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectForbiddenException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListScannerCandidatesOfProjectInternalServerErrorException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
