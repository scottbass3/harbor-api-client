...
class ListScannerCandidatesOfProject extends \Flownative\Harbor\Api\Runtime\Client\BaseEndpoint implements \Flownative\Harbor\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{project_name_or_id}'], [$this->project_name_or_id], '/projects/{project_name_or_id}/scanner/candidates');
    }
     ...
     *
     * @throws \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectBadRequestException
     * @throws \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectUnauthorizedException
     * @throws \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectForbiddenException
     * @throws \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectBadRequestException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (401 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectUnauthorizedException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (403 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectForbiddenException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListScannerCandidatesOfProjectInternalServerErrorException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
