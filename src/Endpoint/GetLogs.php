...
class GetLogs extends \Scottbass3\Harbor\Api\Runtime\Client\BaseEndpoint implements \Scottbass3\Harbor\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Scottbass3\Harbor\Api\Model\AuditLog[]
     *
     * @throws \Scottbass3\Harbor\Api\Exception\GetLogsBadRequestException
     * @throws \Scottbass3\Harbor\Api\Exception\GetLogsUnauthorizedException
     * @throws \Scottbass3\Harbor\Api\Exception\GetLogsInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\AuditLog[]', 'json');
        }
        if (400 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\GetLogsBadRequestException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (401 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\GetLogsUnauthorizedException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\GetLogsInternalServerErrorException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
