...
class ListWebhookPoliciesOfProject extends \Flownative\Harbor\Api\Runtime\Client\BaseEndpoint implements \Flownative\Harbor\Api\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectBadRequestException
     * @throws \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectUnauthorizedException
     * @throws \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectForbiddenException
     * @throws \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectBadRequestException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (401 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectUnauthorizedException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (403 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectForbiddenException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListWebhookPoliciesOfProjectInternalServerErrorException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
