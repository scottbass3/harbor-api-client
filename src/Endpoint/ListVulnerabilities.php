...
class ListVulnerabilities extends \Scottbass3\Harbor\Api\Runtime\Client\BaseEndpoint implements \Scottbass3\Harbor\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Scottbass3\Harbor\Api\Model\VulnerabilityItem[]
     *
     * @throws \Scottbass3\Harbor\Api\Exception\ListVulnerabilitiesBadRequestException
     * @throws \Scottbass3\Harbor\Api\Exception\ListVulnerabilitiesUnauthorizedException
     * @throws \Scottbass3\Harbor\Api\Exception\ListVulnerabilitiesInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\VulnerabilityItem[]', 'json');
        }
        if (400 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListVulnerabilitiesBadRequestException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (401 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListVulnerabilitiesUnauthorizedException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListVulnerabilitiesInternalServerErrorException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
