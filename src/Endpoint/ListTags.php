...
class ListTags extends \Scottbass3\Harbor\Api\Runtime\Client\BaseEndpoint implements \Scottbass3\Harbor\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Scottbass3\Harbor\Api\Model\Tag[]
     *
     * @throws \Scottbass3\Harbor\Api\Exception\ListTagsBadRequestException
     * @throws \Scottbass3\Harbor\Api\Exception\ListTagsUnauthorizedException
     * @throws \Scottbass3\Harbor\Api\Exception\ListTagsForbiddenException
     * @throws \Scottbass3\Harbor\Api\Exception\ListTagsNotFoundException
     * @throws \Scottbass3\Harbor\Api\Exception\ListTagsInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Tag[]', 'json');
        }
        if (400 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListTagsBadRequestException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (401 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListTagsUnauthorizedException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (403 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListTagsForbiddenException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (404 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListTagsNotFoundException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListTagsInternalServerErrorException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
