...
class ListProjects extends \Scottbass3\Harbor\Api\Runtime\Client\BaseEndpoint implements \Scottbass3\Harbor\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Scottbass3\Harbor\Api\Model\Project[]
     *
     * @throws \Scottbass3\Harbor\Api\Exception\ListProjectsUnauthorizedException
     * @throws \Scottbass3\Harbor\Api\Exception\ListProjectsInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Project[]', 'json');
        }
        if (401 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListProjectsUnauthorizedException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListProjectsInternalServerErrorException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
