...
class ListArtifacts extends \Flownative\Harbor\Api\Runtime\Client\BaseEndpoint implements \Flownative\Harbor\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Flownative\Harbor\Api\Model\Artifact[]
     *
     * @throws \Flownative\Harbor\Api\Exception\ListArtifactsBadRequestException
     * @throws \Flownative\Harbor\Api\Exception\ListArtifactsUnauthorizedException
     * @throws \Flownative\Harbor\Api\Exception\ListArtifactsForbiddenException
     * @throws \Flownative\Harbor\Api\Exception\ListArtifactsNotFoundException
     * @throws \Flownative\Harbor\Api\Exception\ListArtifactsInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Artifact[]', 'json');
        }
        if (400 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListArtifactsBadRequestException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (401 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListArtifactsUnauthorizedException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (403 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListArtifactsForbiddenException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (404 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListArtifactsNotFoundException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Flownative\Harbor\Api\Exception\ListArtifactsInternalServerErrorException($serializer->deserialize($body, 'Flownative\Harbor\Api\Model\Errors', 'json'), $response);
        }
