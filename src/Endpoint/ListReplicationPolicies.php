...
class ListReplicationPolicies extends \Scottbass3\Harbor\Api\Runtime\Client\BaseEndpoint implements \Scottbass3\Harbor\Api\Runtime\Client\Endpoint
{
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['q', 'sort', 'page', 'page_size', 'name']);
     ...
     *
     * @throws \Scottbass3\Harbor\Api\Exception\ListReplicationPoliciesUnauthorizedException
     * @throws \Scottbass3\Harbor\Api\Exception\ListReplicationPoliciesForbiddenException
     * @throws \Scottbass3\Harbor\Api\Exception\ListReplicationPoliciesInternalServerErrorException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListReplicationPoliciesUnauthorizedException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (403 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListReplicationPoliciesForbiddenException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
        if (500 === $status) {
            throw new \Scottbass3\Harbor\Api\Exception\ListReplicationPoliciesInternalServerErrorException($serializer->deserialize($body, 'Scottbass3\Harbor\Api\Model\Errors', 'json'), $response);
        }
