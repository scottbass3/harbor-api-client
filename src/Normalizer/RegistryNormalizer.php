...
class RegistryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Flownative\Harbor\Api\Model\Registry::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Flownative\Harbor\Api\Model\Registry::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Flownative\Harbor\Api\Model\Registry();
        ...
        if (\array_key_exists('credential', $data) && $data['credential'] !== null) {
            $object->setCredential($this->denormalizer->denormalize($data['credential'], \Flownative\Harbor\Api\Model\RegistryCredential::class, 'json', $context));
    ...
    {
        return [\Flownative\Harbor\Api\Model\Registry::class => false];
    }
}
