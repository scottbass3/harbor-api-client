...
class RetentionRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\RetentionRule::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\RetentionRule::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\RetentionRule();
        ...
        if (\array_key_exists('tag_selectors', $data) && $data['tag_selectors'] !== null) {
            ...
            foreach ($data['tag_selectors'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Scottbass3\Harbor\Api\Model\RetentionSelector::class, 'json', $context);
            }
        ...
        if (\array_key_exists('scope_selectors', $data) && $data['scope_selectors'] !== null) {
            ...
            foreach ($data['scope_selectors'] as $key_1 => $value_2) {
                ...
                foreach ($value_2 as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \Scottbass3\Harbor\Api\Model\RetentionSelector::class, 'json', $context);
                }
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\RetentionRule::class => false];
    }
}
