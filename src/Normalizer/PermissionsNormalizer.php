...
class PermissionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\Permissions::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\Permissions::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\Permissions();
        ...
        if (\array_key_exists('system', $data) && $data['system'] !== null) {
            ...
            foreach ($data['system'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Scottbass3\Harbor\Api\Model\Permission::class, 'json', $context);
            }
        ...
        if (\array_key_exists('project', $data) && $data['project'] !== null) {
            ...
            foreach ($data['project'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Scottbass3\Harbor\Api\Model\Permission::class, 'json', $context);
            }
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\Permissions::class => false];
    }
}
