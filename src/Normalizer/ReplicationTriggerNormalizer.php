...
class ReplicationTriggerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('triggerSettings') && null !== $data->getTriggerSettings()) {
            $dataArray['trigger_settings'] = $this->normalizer->normalize($data->getTriggerSettings(), 'json', $context);
        }
