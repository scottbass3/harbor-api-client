...
class BoolConfigItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\BoolConfigItem::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\BoolConfigItem::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\BoolConfigItem();
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\BoolConfigItem::class => false];
    }
}
