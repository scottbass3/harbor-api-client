...
class ConfigurationsResponseScanAllPolicyParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\ConfigurationsResponseScanAllPolicyParameter::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\ConfigurationsResponseScanAllPolicyParameter::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\ConfigurationsResponseScanAllPolicyParameter();
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('dailyTime') && null !== $data->getDailyTime()) {
            $dataArray['daily_time'] = $data->getDailyTime();
        }
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\ConfigurationsResponseScanAllPolicyParameter::class => false];
    }
}
