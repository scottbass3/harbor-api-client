...
class UserRespNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\UserResp::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\UserResp::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\UserResp();
        ...
        if (\array_key_exists('oidc_user_meta', $data) && $data['oidc_user_meta'] !== null) {
            $object->setOidcUserMeta($this->denormalizer->denormalize($data['oidc_user_meta'], \Scottbass3\Harbor\Api\Model\OIDCUserInfo::class, 'json', $context));
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\UserResp::class => false];
    }
}
