...
class ProjectSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\ProjectSummary::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\ProjectSummary::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\ProjectSummary();
        ...
        if (\array_key_exists('quota', $data) && $data['quota'] !== null) {
            $object->setQuota($this->denormalizer->denormalize($data['quota'], \Scottbass3\Harbor\Api\Model\ProjectSummaryQuota::class, 'json', $context));
        ...
        if (\array_key_exists('registry', $data) && $data['registry'] !== null) {
            $object->setRegistry($this->denormalizer->denormalize($data['registry'], \Scottbass3\Harbor\Api\Model\Registry::class, 'json', $context));
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\ProjectSummary::class => false];
    }
}
