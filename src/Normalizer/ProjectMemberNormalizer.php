...
class ProjectMemberNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\ProjectMember::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\ProjectMember::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\ProjectMember();
        ...
        if (\array_key_exists('member_user', $data) && $data['member_user'] !== null) {
            $object->setMemberUser($this->denormalizer->denormalize($data['member_user'], \Scottbass3\Harbor\Api\Model\UserEntity::class, 'json', $context));
        ...
        if (\array_key_exists('member_group', $data) && $data['member_group'] !== null) {
            $object->setMemberGroup($this->denormalizer->denormalize($data['member_group'], \Scottbass3\Harbor\Api\Model\UserGroup::class, 'json', $context));
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\ProjectMember::class => false];
    }
}
