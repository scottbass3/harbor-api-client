...
class RetentionRuleMetadataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Scottbass3\Harbor\Api\Model\RetentionRuleMetadata::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Scottbass3\Harbor\Api\Model\RetentionRuleMetadata::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Scottbass3\Harbor\Api\Model\RetentionRuleMetadata();
        ...
        if (\array_key_exists('params', $data) && $data['params'] !== null) {
            ...
            foreach ($data['params'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Scottbass3\Harbor\Api\Model\RetentionRuleParamMetadata::class, 'json', $context);
            }
    ...
    {
        return [\Scottbass3\Harbor\Api\Model\RetentionRuleMetadata::class => false];
    }
}
