...
class RegistryProviderEndpointPatternNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Flownative\Harbor\Api\Model\RegistryProviderEndpointPattern::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Flownative\Harbor\Api\Model\RegistryProviderEndpointPattern::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Flownative\Harbor\Api\Model\RegistryProviderEndpointPattern();
        ...
        if (\array_key_exists('endpoints', $data) && $data['endpoints'] !== null) {
            ...
            foreach ($data['endpoints'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Flownative\Harbor\Api\Model\RegistryEndpoint::class, 'json', $context);
            }
    ...
    {
        return [\Flownative\Harbor\Api\Model\RegistryProviderEndpointPattern::class => false];
    }
}
